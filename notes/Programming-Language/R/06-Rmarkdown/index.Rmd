...
# use necessary packages
library('pacman')
p_load(lubridate, reshape2, # 数据整理
...
代码：`<span style='color: blue'> 蓝色文字。</span>`

效果：<span  style='color: blue'>蓝色文字。</span>
...
为了产生对齐的公式，在独立公式中可使用 aligned 环境。
...
更优美的表格：https://haozhu233.github.io/kableExtra/
