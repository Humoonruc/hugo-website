...
\subsection{研究思路与方法}\label{section-3}}
...
\subsection{全文结构}\label{section-4}}
...
\section[不完备模型]{\texorpdfstring{不完备模型\footnote{A Model of Technology, Prices, and Trade Flows. 半个一般均衡模型：将要素价格作为外生变量，仅考虑需求端。}}{不完备模型}}\label{section-5}}
